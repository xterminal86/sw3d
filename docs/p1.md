...
Like it was mentioned, idea of Bresenham algorithm is to to light up those pixels whose distance to the "real" one is the smallest. 

![](images/bresenham-trick.png)
...
![](images/line-mirror-drawing.png)
