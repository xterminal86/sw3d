...
I kinda measured time from both rasterizers described here and it seems that scanline version works a _little_ bit faster, which was expected. Scanline version produces around 520 quite stable FPS on average, while PIT version settles at around 480, but fluctuates more (FPS jumps -20 to +20 from average value). Maybe either one could be improved, but I think it's fine as it is.

<table>
  <tr>
    <td><img src="images/p2/pr-fps.png"></td>
    <td><img src="images/p2/sr-fps.png"></td>
  </tr>
</table>
...
Also, note that in this case we also need to always capture first yielded points from generators in all cases: this way we'll ensure that, for example, FT triangle connects nicely to a FB triangle and rightmost edge doesn't get overdrawn. So we don't even need any `PointCaptureType` stuff.
...
So I guess _maybe_ it works? At least for meshes? I don't know, we'll see I guess.

----

At least for the moment I don't know how to solve this top-left artifacts problem apart from going into subpixel precision. Which I have yet to research, and I'm still not sure that this will help.
